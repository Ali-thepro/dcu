...
for line in sys.stdin:
    ...
    mul_3 = [n for n in r if n % 3 == 0]
    mul_3_sq = [n * n for n in r if n % 3 == 0]
    mul_4_double = [n * 2 for n in r if n % 4 == 0]
    mul_3_or_4 = [n for n in r if n % 3 == 0 or n % 4 == 0]
    mul_3_and_4 = [n for n in r if n % 3 == 0 and n % 4 == 0]
